...
<div class="container-fluid">
    ...
    ?>
    <h2>Data Mitra</h2>
    <a href="?page=tabelMitra&aksi=input" class="btn btn-primary mb-3 mt-3"><i class="bi bi-plus-circle"></i> New</a>
    <div class="table-responsive col-12">
        <table id="tabel-mitra" class="table table-bordered table-striped border-left-warning">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Instansi</th>
